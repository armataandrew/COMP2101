...
while [ -v $userguess ] || [ $userguess -gt 10 ] || [ $userguess -lt 1 ] || [ $userguess != $secretnumber ]; do # ask repeatedly until they get it right
  [ $userguess -gt $secretnumber ] && echo "your guess is high" || echo "your guess is low"
